...
public class PermissionsUtil {
    ...
    public static final class Permission {
        ...
        private static final List<String> sSystemAlert = new ArrayList<>(1);
        ...
        static {
            ...
            //sSystemalert
            sSystemAlert.add(SystemAlert.SYSTEM_ALERT_WINDOW);
        }
...
//        }
    ...
    private String createRationaleMsg(Context context, String... permissions) {
        ...
        return getAppName(context) + context.getResources().getString(R.string.need_text) + permissionsMsg + context.getResources().getString(R.string.permission_setting_tips);
    }
    ...
    private String createPermissionsMsg(String... permissions) {
        ...
        for (String permission : permissions) {
            ...
            if (!grantedStorage && Permission.sSystemAlert.contains(permission)) {
                builder.append(Permission.Storage.MSG);
                builder.append("、");
                grantedStorage = true;
            }
